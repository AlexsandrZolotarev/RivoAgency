    ...
    <div className={s.VacanciesForm}>
      <div>
        ...
        <input
          tabIndex="0"
          ref={positionJob}
          onChange={onVacancichange.bind(this)}
          type="text"
          id="positionJob"
          name="positionJob"
          value={props.newCareerVacanci.positionJob}
        ></input>
      </div>
      <div>
        <label>Name</label>
        <input
          ...
          id="name"
          name="name"
          value={props.newCareerVacanci.name}
        ></input>
      </div>
      <div>
        <label>Salary</label>
        <input
          ...
          id="salary"
          name="salary"
          value={props.newCareerVacanci.salary}
        ></input>
      </div>
      <div>
        <label>Region</label>
        <input
          ...
          id="region"
          name="region"
          value={props.newCareerVacanci.region}
        ></input>
      </div>
      <div className={s.addNewVacanciBody}>
        <button className={s.addNewVacanciButton} onClick={addNewVacanci}>
          Add new
        </button>
      </div>
    </div>
        ...
        <div className={s.Wrapper_Career}>
          <div className={s.Wrapper_Career__Title}>
            ...
            <div className={s.Wrapper_Career__Title_title}>
              ...
              <p>
                As we are continuously growing, we require new talents to join
                our professional team. Please provide us with your information
                and portfolio and we will contact you shortly.
              </p>
            </div>
          </div>
            ...
            <div className={s.Wrapper_Career__Vacancies_vacancies}>
              <ul className={s.vacancies}>
                {this.props.careerVacancies.map((v) => (
                  <Vacanci key={v.id} v={v} />
                ))}
              </ul>
              <AddNewVacancies props={this.props} />
            </div>
          </div>
        </div>
      </div>
