            ...
            <div className={s.ServiceItem + " Item"}>
              ...
              <div className={s.ServiceItem_Text}>
                <p>
                  ...
                  business efficiency and gain an influx of potential customers.
                  Having 10+ years of experience as a web and mobile app
                  development company, we know how to create fast and powerful
                  web apps that will serve your business for years.
                </p>
              </div>
            ...
            <div className={s.ServiceItem + " Item"}>
              ...
              <div className={s.ServiceItem_Text}>
                <p>
                  ...
                  business to a large audience, keep in touch with your clients,
                  discover their needs, and win their loyalty. Our app
                  developers create custom solutions for iOS and Android devices
                  that simplify customer experience.
                </p>
              </div>
              <div className={s.ServiceItem + " ServiveButton"}>
                <a>Make order</a>
            ...
            <div className={s.ServiceItem + " Item"}>
              ...
              <div className={s.ServiceItem_Text}>
                <p>
                  ...
                  industries, we deliver custom software tailored to your
                  specific business needs. Our experts design and develop
                  fast-loading, secure, and scalable SaaS solution that is
